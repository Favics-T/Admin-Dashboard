...
const Device = () => {
  return (
    <div className='bg-white text-[#3A3541] text-[16px] lato cursor-pointer rounded-lg flex flex-col items-center py-8 justify-center md:w-[250px] w-[290px] h-[340px] shadow-md'>
      <div className='flex flex-col gap-8 w-full px-4'>
        <h1 className='text-[#3A3541] font-medium text-[20.25px]'>Device Category</h1>
