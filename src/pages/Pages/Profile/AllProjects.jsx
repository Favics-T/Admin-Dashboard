...
const Avatar = ({ src, index }) => (
  <div className={`${index !== 0 ? '-ml-1' : ''} border-1 border-white rounded-full`}>
    ...
    <div className="rounded-lg lato gap-6 p-4 text-[#89868D] shadow-lg hover:shadow-xl transition flex flex-col  justify-between">
      ...
      <div className="flex justify-between">
        <div className="flex gap-3 items-start">
          ...
          <div>
            <h2 className="font-semibold text-[#3A3541]">{title}</h2>
    ...
    },
    {
       id: 2,
        ...
        
        {
         ...
         {
           id: 6, title: "Premium Support", desc: "Pick a subscription that best fits your needs and get started.", tasks: 32, date: "25.02.22", color: "bg-purple-100 text-purple-600", 
          }, { id: 7, title: "Looking great", desc: "We have the UI specifically to play the game of life.", tasks: 30, date: "20.02.22", color: "bg-orange-100 text-orange-600", }, { id: 8, title: "Design tools", desc: "Consistent UI provides. We constantly making updates and add new features.", tasks: 30, date: "03.02.22", color: "bg-pink-100 text-pink-600", },
  ];
  ...
  return (
    <div className="bg-white min-h-screen p-6 rounded-lg shadow-sm">
      ...
      <div className="py-6 bg-[#E7E7F4] rounded-t-lg px-2">
        <h1 className="text-lg font-semibold text-[#3A3541]">Some of Our Awesome Projects</h1>
      </div>
